...
public class ShipServiceImpl implements ShipService{
    ...
    @Override
    public void addNewShip(Ship ship) throws Exception {
        if(ship.getUsed() == null){
            ship.setUsed(false);
        }
        isNameValidated(ship.getName());
        isCrewSizeValidated(ship.getCrewSize());
    ...
    public Ship updateShip(Long id, Ship ship) {
        ...
        if (ship.getName() != null && isNameValidated(ship.getName())) {
        ...
        if (ship.getCrewSize() != null && isCrewSizeValidated(ship.getCrewSize())) {
    ...
    private Boolean isCrewSizeValidated(Integer crewSize){
    ...
    private Double calculateRating(Ship ship){
        ...
        double currentRating = ((80 * ship.getSpeed() * k) / (currentYear - year + 1));
